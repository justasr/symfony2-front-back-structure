...
class ScriptHandler
{
    ...
    protected static $options = array(
        ...
        'front-app-dir' => 'frontend/app',
        'front-web-dir' => 'frontend/web',
        'front-bin-dir' => 'frontend/bin',

        'back-app-dir' => 'backend/app',
        'back-web-dir' => 'backend/web',
        'back-bin-dir' => 'backend/bin'
     ...
     * @param $event CommandEvent A instance
     */
    public static function buildBootstraps(CommandEvent $event)
    {
        $options = static::getOptions($event);

        $frontendOptions = $options;
        $frontendOptions['symfony-app-dir'] = $options['front-app-dir'];
        $frontendOptions['symfony-web-dir'] = $options['front-web-dir'];
        $frontendOptions['symfony-bin-dir'] = $options['front-bin-dir'];
        static::buildFront($event, $frontendOptions);

        $backendOptions = $options;
        $backendOptions['symfony-app-dir'] = $options['back-app-dir'];
        $backendOptions['symfony-web-dir'] = $options['back-web-dir'];
        $backendOptions['symfony-bin-dir'] = $options['back-bin-dir'];
        static::buildBack($event, $backendOptions);
     ...
     * @param $options
     */
    public static function buildFront($event, $options) {
        $bootstrapDir = $autoloadDir = $options['symfony-app-dir'];
     ...
     * @param $options
     */
    public static function buildBack($event, $options) {
        $bootstrapDir = $autoloadDir = $options['symfony-app-dir'];
     ...
     * @param $event CommandEvent A instance
     */
    public static function clearCaches(CommandEvent $event)
    {
        $options = static::getOptions($event);
        ...
        $frontendOptions['symfony-web-dir'] = $options['front-web-dir'];
        $frontendOptions['symfony-bin-dir'] = $options['front-bin-dir'];
        static::backClearCache($event, $frontendOptions);

        $backendOptions = $options;
        $backendOptions['symfony-app-dir'] = $options['back-app-dir'];
        $backendOptions['symfony-web-dir'] = $options['back-web-dir'];
        $backendOptions['symfony-bin-dir'] = $options['back-bin-dir'];
        static::frontClearCache($event, $backendOptions);
    }
     ...
     * @param $event CommandEvent A instance
     */
    public static function frontClearCache(CommandEvent $event, $options)
    {
        $consoleDir = static::getConsoleDir($event, 'clear the cache');
     ...
     * @param $event CommandEvent A instance
     */
    public static function backClearCache(CommandEvent $event, $options)
    {
        $consoleDir = static::getConsoleDir($event, 'clear the cache');
     ...
     * @param $event CommandEvent A instance
     */
    public static function installAssetsFB(CommandEvent $event)
    {
        $options = static::getOptions($event);
        ...
        $frontendOptions['symfony-web-dir'] = $options['front-web-dir'];
        $frontendOptions['symfony-bin-dir'] = $options['front-bin-dir'];
        static::frontInstallAssets($event, $frontendOptions);

        $backendOptions = $options;
        $backendOptions['symfony-app-dir'] = $options['back-app-dir'];
        $backendOptions['symfony-web-dir'] = $options['back-web-dir'];
        $backendOptions['symfony-bin-dir'] = $options['back-bin-dir'];
        static::backInstallAssets($event, $backendOptions);
     ...
     * @param $event CommandEvent A instance
     */
    public static function frontInstallAssets(CommandEvent $event, $options)
    {
        $consoleDir = static::getConsoleDir($event, 'install assets');
     ...
     * @param $event CommandEvent A instance
     */
    public static function backInstallAssets(CommandEvent $event, $options)
    {
        $consoleDir = static::getConsoleDir($event, 'install assets');
     ...
     * @param $event CommandEvent A instance
     */
    public static function installRequirementsFiles(CommandEvent $event)
    {
        $options = static::getOptions($event);
        ...
        $frontendOptions['symfony-web-dir'] = $options['front-web-dir'];
        $frontendOptions['symfony-bin-dir'] = $options['front-bin-dir'];
        static::evnInstallRequirementsFile($event, $frontendOptions);

        $backendOptions = $options;
        $backendOptions['symfony-app-dir'] = $options['back-app-dir'];
        $backendOptions['symfony-web-dir'] = $options['back-web-dir'];
        $backendOptions['symfony-bin-dir'] = $options['back-bin-dir'];
        static::evnInstallRequirementsFile($event, $backendOptions);
     ...
     * @param $event CommandEvent A instance
     */
    public static function evnInstallRequirementsFile(CommandEvent $event, $options)
    {
        $options = static::getOptions($event);
        $appDir = $options['symfony-app-dir'];
        $fs = new Filesystem();
    ...
    public static function removeSymfonyStandardFilesFB(CommandEvent $event)
    {
        $options = static::getOptions($event);
        ...
        $frontendOptions['symfony-web-dir'] = $options['front-web-dir'];
        $frontendOptions['symfony-bin-dir'] = $options['front-bin-dir'];
        static::evnRemoveSymfonyStandardFiles($event, $frontendOptions);

        $backendOptions = $options;
        $backendOptions['symfony-app-dir'] = $options['back-app-dir'];
        $backendOptions['symfony-web-dir'] = $options['back-web-dir'];
        $backendOptions['symfony-bin-dir'] = $options['back-bin-dir'];
        static::evnRemoveSymfonyStandardFiles($event, $backendOptions);
    }

    public static function evnRemoveSymfonyStandardFiles(CommandEvent $event,$options)
    {
        $options = static::getOptions($event);
        $appDir = $options['symfony-app-dir'];
